...
@implementation UITextView (AGPlaceholder)
...
+ (UIColor *)ag_defaultPlaceholderColor {
    if (@available(iOS 13, *)) {
...
- (UITextView *)ag_placeholderTextView {
    UITextView *textView = objc_getAssociatedObject(self, @selector(placeholderTextView));
    if (!textView) {
...
- (NSAttributedString *)ag_attributedPlaceholder {
